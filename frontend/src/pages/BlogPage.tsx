  ...
  const allArticles = [
    {
      ...
      description:
        "本文將介紹如何使用 React 18 和 TypeScript 4 建立一個現代化的網站，包含最佳實踐和性能優化技巧。",
      date: "2024-03-15",
      readTime: "8 min",
    ...
    },
    {
      ...
      description:
        "探索 Next.js 13 中新的 App Router 功能，了解其優勢以及如何在專案中充分利用它。",
      date: "2024-03-10",
      readTime: "10 min",
    ...
    },
    {
      ...
      description:
        "分享在實際專案中使用 Tailwind CSS 的各種技巧和經驗，讓你的開發更加高效。",
      date: "2024-03-05",
      readTime: "6 min",
    ...
    },
    {
      ...
      description:
        "從基礎概念到實際應用，全面了解 Docker 容器化技術，以及如何在開發流程中有效運用。",
      date: "2024-03-01",
      readTime: "12 min",
    ...
    },
    {
      ...
      description:
        "探討 GraphQL API 設計中的關鍵考量因素，以及如何構建高效且易於維護的 API。",
      date: "2024-02-28",
      readTime: "9 min",
    ...
    },
    {
      ...
      title: "前端效能優化指南",
      description:
        "從載入速度到運行效能，全方位提升前端應用的效能表現，包含實用技巧和工具推薦。",
      date: "2024-02-25",
      readTime: "11 min",
    ...
    },
    {
      ...
      description:
        "深入探討 React Server Components 的應用場景和實作方式，了解其優勢和使用時機。",
      date: "2024-02-20",
      readTime: "15 min",
    ...
    },
    {
      ...
      title: "現代化 CSS 開發技巧",
      description:
        "介紹 CSS 最新特性和開發技巧，包含 Grid、Flexbox、CSS 變數等進階應用。",
      date: "2024-02-15",
      readTime: "7 min",
    ...
    },
    {
      ...
      title: "微服務架構設計實踐",
      description:
        "探討微服務架構的設計原則、實作考量，以及在實際專案中的應用經驗分享。",
      date: "2024-02-10",
      readTime: "13 min",
    ...
    },
    {
      ...
      description:
        "深入探討 TypeScript 的進階特性和使用技巧，提升程式碼的型別安全性和可維護性。",
      date: "2024-02-05",
      readTime: "10 min",
  ...
  return (
    <div className="flex justify-center w-full">
      <div className="container max-w-6xl px-4 py-8">
        <TitleBar title="我的文章" subtitle="分享技術知識與學習心得" />
                  ...
                  {Array.from({ length: totalPages }).map((_, i) => (
                    <PaginationItem key={i}>
                      <PaginationLink
                        ...
                        className={`${
                          currentPage === i + 1 ? "bg-zinc-600" : "bg-zinc-800"
